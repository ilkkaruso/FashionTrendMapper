...
must_haves:
  truths:
    ...
    - "Modal displays trend name, description, score, change %"
...
<task type="auto">
  ...
  <done>
    TrendModal displays trend name, description (MODAL-02), score, change %, sources, related trends.
...
3. Modal displays: title, description, score, change %, source breakdown, related trends
...
10. Description shown when available (MODAL-02 satisfied)
</success_criteria>
